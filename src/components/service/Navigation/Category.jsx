...
const WrappedIcon = ({ Icon, handleClick }) => (
  <div css={wrappedIconStyle} onClick={handleClick}>
    <Icon />
  </div>
);
    ...
    <div css={categoryStyle(isDragging, isOver)} ref={(node) => dragRef(dropRef(node))}>
      <div css={categoryNameWrapperStyle}>
        ...
        <div className="hover-buttons" css={categoryHoverButtons}>
          <WrappedIcon Icon={Add} handleClick={handleClickCreateBoard} />
          <WrappedIcon Icon={Ellipsis} handleClick={handleClickMenu} />
        </div>
      </div>
